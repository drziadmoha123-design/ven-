...
AWARD\_DELIVERY\_POINTS\_ON\_POINTS\_REDEMPTION
...
paymentMethod = CASH\_ON\_DELIVERY
...
FREE\_SHIPPING\_POINTS\_THRESHOLD
...
CUSTOMER\_REQUESTED\_CHANGE

INVALID\_NUMBER

CALL\_BACK\_REQUIRED
...
CANCELLATION\_RESTORATION

RETURN\_RESTORATION

ADMIN\_ADJUSTMENT

AMENDMENT\_ADJUSTMENT
...
AWARD\_DELIVERY\_POINTS\_ON\_POINTS\_REDEMPTION = FALSE
...
POINTS\_PRODUCT\_REDEMPTION

POINTS\_PRODUCT\_REFUND

FREE\_SHIPPING\_REDEMPTION

FREE\_SHIPPING\_REFUND
...
REFERRAL\_REWARD\_EARNED

REFERRAL\_REWARD\_REVERSED
...
ORDER\_CONFIRMATION\_REQUIRED

HIGH\_CONFIRMATION\_ATTEMPTS

LOW\_STOCK

OUT\_OF\_STOCK

DELIVERY\_IMPORT\_COMPLETED

DELIVERY\_IMPORT\_FAILED

ORDER\_IMPORT\_COMPLETED

ORDER\_IMPORT\_FAILED
...
exactly once when order enters PENDING\_CONFIRMATION.
...
sum of TOTAL CASH DUE for CUSTOMER\_REFUSED orders.
...
INVALID\_REFERRAL\_CODE

SELF\_REFERRAL

REFERRAL\_ALREADY\_ASSIGNED
...
docs/ORDER\_LIFECYCLE.md

docs/ORDER\_CONFIRMATION.md

docs/ORDER\_AMENDMENTS.md

docs/POINTS\_SPEC.md

docs/REFERRAL\_SPEC.md

docs/INVENTORY\_SPEC.md

docs/DELIVERY\_SPEC.md

docs/EXCEL\_IMPORT\_SPEC.md

docs/IMAGE\_SPEC.md

docs/SHIPPING\_SPEC.md

docs/NOTIFICATIONS\_SPEC.md
...
Phase 1 payment method = CASH\_ON\_DELIVERY
...
YES on DELIVERED → CUSTOMER\_REFUSED



Referral Re-award:

YES on CUSTOMER\_REFUSED → DELIVERED when valid
